...
- **Template:** `11869800` (mc:edit-capable)
- **Status:** Draft — pending Mine Cleanup registration link for Section 2 CTA
- **Note:** Template ID corrected from 11869768 → 11869800 on 2026-05-03
...
### Member Sync — May 2026
- Cross-referenced 211-member SAME national roster against Mailchimp
- Added 64 new subscribers; applied `Members` tag to 197 roster contacts
- 3 .mil addresses (MacCumbee, Jenkinson, Anaya) must be added manually via Mailchimp UI
- 11 BillHighway placeholder emails need real addresses from SAME national
- 15 unsubscribed/cleaned members cannot be resubscribed without opt-in
- Subscriber count grew: ~914 → ~978
- Script: `scripts/sync-members.py` — quarterly cadence (Mar/Jun/Sep/Dec)
